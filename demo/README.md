...
```shell
./docker/start_db_cluster.sh docker.io/arangodb/arangodb:3.7.11
```
...
docker run -it --rm \
  ...
  ./spark/bin/spark-shell --master spark://spark-master:7077 \
    --jars="/arangodb-spark-datasource/arangodb-spark-datasource-2.4/target/arangodb-spark-datasource-2.4-0.0.1-SNAPSHOT-jar-with-dependencies.jar"
```
...
docker run -it --rm \
  ...
  ./spark/bin/spark-submit --master spark://spark-master:7077 \
    --jars="/arangodb-spark-datasource/arangodb-spark-datasource-2.4/target/arangodb-spark-datasource-2.4-0.0.1-SNAPSHOT-jar-with-dependencies.jar" \
    --class Demo /arangodb-spark-datasource/demo/target/demo-0.0.1-SNAPSHOT.jar
```
...
docker run -it --rm \
  ...
  ./spark/bin/spark-shell --master spark://spark-master:7077 \
    --jars="/arangodb-spark-datasource/arangodb-spark-datasource-3.1/target/arangodb-spark-datasource-3.1-0.0.1-SNAPSHOT-jar-with-dependencies.jar"
```
